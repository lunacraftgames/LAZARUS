...
| **阿特拉斯** ATLAS-9 | 通关第二章 | 高大的重型工程外骨骼，工程黄配铆钉和黑黄警示条，液压臂，背着喷气背包 | **喷气悬停**：空中按住跳跃，喷气背包托着你悬停、缓慢上升（按住跳跃最高约 6.6 格，平飞约 12 格），燃料落地回满，被粘液粘住或无人机警报时用不了。**地面猛击**：空中按冲刺垂直砸下，落地的冲击波向两侧推开，还会震塌坍塌石板。**液压踏地**：地上按冲刺原地震一下，打碎身边的敌人。没有冲刺，第三章的代码残影在踏地 / 猛击时留下，持续 4 秒 | 专属**液压拳**：慢（0.42 秒）但范围大，能打碎看守者的盾牌。**臂盾**：站在地上时，正面飞来的子弹、炸弹、粘液团会被挡下 | 跑得慢、惯性大、跳得矮，没有冲刺和二段跳、不能下蹲；不能使用拉撒路的武器 |
| **赤影** VESPER | 通关第三章 | 半透明的红色数字人形，戴兜帽，像素边缘不停抖动——第三章 Boss 镜像拉撒路被格式化后残留在回收站里的一段残片 | **相位闪现**（冲刺键）：朝 8 个方向瞬移约 4 格，途中无敌，能穿过 1 格厚的瓦片墙 / 天花板，但穿不过代码门、升降台、坍塌石板等机关；空中一次，落地恢复（跳到最高点再朝上闪现能升 8 格多）。**回溯**（换武器键）：回到 2 秒前的位置，冷却 4 秒，误闪进死角时也能用它退回去。第三章的代码残影留在闪现起点，持续 3 秒 | 专属**数据刃**：出手很快（冷却 0.2 秒），挥过的地方会留下一瞬间的残像；破不了看守者的盾牌 | 没有二段跳、不能下蹲；不能使用拉撒路的武器（换武器键被回溯占用） |
| **信使** EVA-0 | 集齐全部记忆芯片（隐藏结局） | 白橙配色的轻型机体，老式护目镜，头顶一根小天线，背后一对布料滑翔翼——隐藏结局里避难所的人类照着伊娃的图纸造的原型机 | **抓钩**（冲刺键）：朝斜上方射出钩子（按住 ↑ = 正上方，射程约 7 格），钩住墙或天花板就挂上去；← → 荡秋千，↑ ↓ 收放绳子，跳跃键松手并借力弹起，挂着时再按冲刺键 = 立刻重新出钩。钩在台子边缘附近会吸到边角上，收绳到底自动翻上台子（地面上最高能上 8 格）；单向平台挡不住钩子。警报时射不出去。**滑翔翼**：空中按住跳跃缓慢下落（滑翔比约 2 : 1，平地助跑能飘 10 格多），被粘液粘住时展不开。第三章的代码残影留在出钩的位置 | 专属**信号枪**：远程，信号弹不致死，只会把敌人打晕约 2.6 秒——晕着的敌人原地不动、碰了不疼，踩头收尾；盾牌、软体怪、镜像执行官照常挡下 | 攻击力最弱；没有冲刺和二段跳、不能下蹲；不能使用拉撒路的武器 |

- 小扫身高只有拉撒路的 2/3，第三章冲刺残影、第四章重力反转（在翻转的重力下 ↑ 指向自己的头顶）都照常生效；一键模式里同样变成方块。
- 在培养液里不能吸附。
- **背景音乐随角色调整**（`js/audio.js` 的 `STYLES`）：同一首曲子换一种演奏方式。小扫的「铁皮玩具」风格：速度快约 12%，厚重的锯齿波铺底换成柔和的三角波，旋律高八度、短促跳跃，再加上刷子沙锤、六条腿的三连拍嗒嗒声和小扫的五音动机；阿特拉斯的「钢铁」风格：速度放慢到 0.9 倍，旋律换成滤波锯齿波（像铜管、像机器），低音和底鼓更重，再加上二、四拍的铁砧敲击、液压泄气的嘶声、齿轮的闷响和一段低音铜管动机；赤影的「幻影」风格：速度快约 4%，旋律换成轻微走音的方波，每隔一拍留下一段错位的回声（像信号卡顿），铺底换成闷住的方波，再加上故障咔嗒声、每两小节一次向下扫的「回溯」音，以及一段先正放、再倒放的镜像动机；信使的「微风」风格：速度放慢到 0.96 倍，旋律换成像口哨一样柔和的正弦 / 三角波、余音更长、混响更多，锯齿波铺底换成轻柔的三角波，再加上慢慢起伏的风声、像荡秋千一样左右来回的琶音，以及每 4 小节一次的摩尔斯电码「E · V · A」。标题 / 剧情电台、结局、终局黑暗这类安静的曲目只换音色、保持原速。角色界面里选中哪个角色就会试听它的风格。
- **剧情台词随角色调整**（`js/char_lines.js`）：小扫的周目里，Omni-Mind 把「拉撒路协议」装进了博物馆里一只被踩碎的除尘蜘蛛——开场与结局剧情、伊娃的称呼、能力与武器教学、Omni-Mind 的真相与终局台词、结局铭牌、隐藏结局、第三章 Boss「镜像小扫」都会随之改变；阿特拉斯的周目里，协议被装进了机械展区一台拆掉电池的重型工程外骨骼，冲刺 / 二段跳的教学都改成喷气与猛击，结局铭牌是「展品 #0003 · ATLAS-9」；赤影的周目里，Omni-Mind 把第三章那个被格式化的镜像从回收站里捞了回来，开场是黑屏显示器里闪过的一道红色残影，冲刺的教学都改成相位闪现与回溯，第三章 Boss 变成「镜像赤影」，结局铭牌是「展品 #0004 · VESPER 数据残片。它不是任何人的复制品。」；信使的周目里，避难所的人类照着伊娃的图纸造了 EVA-0，用降落伞把它从通风井空投进博物馆，任务是「送信」——教学都改成抓钩、滑翔和「先打晕、再踩头」，结局铭牌是「展品 #0005 · EVA-0 信使原型机。它把一封信，送到了世界的尽头。」，隐藏结局里给它缝翅膀的女孩说「欢迎回家，小信使。」；记忆芯片档案记录的是过去的历史，仍然围绕 LZ-01。新增角色时，在 `CHAR_TEXT` 里写整句改写（`lines`）和称呼替换（`subs`）即可。
